    ...
    <>
        <div className='p-8'>
          ...
          <div id='form w-full'>
            ...
            <label htmlFor="">RestaurantId<input type="text" placeholder='RestaurantId' name='restaurantId' value={fields.restaurantId} onChange={(e)=> setFields({...fields, [e.target.name]: e.target.value})} className=' p-2 outline-0 rounded border w-full my-2'/></label>
